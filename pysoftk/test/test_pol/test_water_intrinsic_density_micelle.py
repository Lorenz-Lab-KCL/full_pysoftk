...
def test_intrinsic_density_cyclic_water(rootdir):
    ...
    density_whole = intrinsic_density_water(topology, trajectory).run_intrinsic_density(resids, atom_pos, ['OW'], MA_names_c, ['OW'], 75, 10000, 1)

    density_whole_f = np.array(list(density_whole))
